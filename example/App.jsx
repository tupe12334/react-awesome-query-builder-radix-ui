      ...
      <div className="query-builder-result" style={{ padding: '20px' }}>
        ...
        <div style={{ marginBottom: '10px' }}>
          ...
          <pre style={{
            ...
            {JSON.stringify(QbUtils.queryString(immutableTree, config), null, 2)}
          </pre>
        </div>
        <div style={{ marginBottom: '10px' }}>
          ...
          <pre style={{
            ...
            {JSON.stringify(QbUtils.mongodbFormat(immutableTree, config), null, 2)}
          </pre>
        </div>
        <div style={{ marginBottom: '10px' }}>
        ...
        <div style={{ marginBottom: '10px' }}>
          ...
          <pre style={{
            ...
            {JSON.stringify(QbUtils.jsonLogicFormat(immutableTree, config), null, 2)}
          </pre>
        </div>
        <div>
